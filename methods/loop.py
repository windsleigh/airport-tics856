...
def loop():
    ...
    plane_event6 = Event(1, "ArrivePlane", plane6)
    plane_event7 = Event(1, "ArrivePlane", plane7)
    plane_event8 = Event(1, "ArrivePlane", plane8)
    plane_event9 = Event(1, "ArrivePlane", plane9)
    plane_event10 = Event(1, "ArrivePlane", plane10)
    plane_event11 = Event(1, "ArrivePlane", plane11)
    plane_event12 = Event(1, "ArrivePlane", plane12)
    plane_event13 = Event(1, "ArrivePlane", plane13)
    plane_event14 = Event(1, "ArrivePlane", plane14)
    plane_event15 = Event(1, "ArrivePlane", plane15)
    plane_event16 = Event(1, "ArrivePlane", plane16)
    plane_event17 = Event(1, "ArrivePlane", plane17)
    plane_event18 = Event(1, "ArrivePlane", plane18)
    plane_event19 = Event(1, "ArrivePlane", plane19)
    plane_event20 = Event(1, "ArrivePlane", plane20)
